...
public class BitCollector implements Iterable<Boolean>
{
	 ...
	 */
	public byte[] toByteArray(BitSequence.ALIGN align){
    	if(align == BitSequence.ALIGN.RIGHT){
	...
	public String toBynaryString(){
    	...
    	BitSequence bitSequence = new BitSequence(bArr, targetBitsCount, BitSequence.ALIGN.RIGHT);
	 ...
	 */
    public String toBynaryString(BitSequence.ALIGN align, BitSequence.GROUP groupType){
    	BitCollector bc;
    	if(isClosed){
    		bc = this;
    	}else{
    ...
    public BitSequence toBitSequence(){
		BitSequence seq = new BitSequence(this.toByteArray(), this.targetBitsCount, BitSequence.ALIGN.RIGHT);
		return seq;
